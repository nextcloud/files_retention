OC.L10N.register(
    ...
    "Invalid tag selected" : "تمّ تحديد سِمَة tag غير صحيحة",
    "Tag {tagName} already has a retention rule" : " السمة {tagName} لها قاعدة احتفاظ مرتبطة بها سلفاً",
    ...
    "Retention rule for tag {tagName} saved" : "تمّ حفظ قاعدة الاحتفاظ المرتبطة بالسِّمَة {tagName} ",
    "Failed to save retention rule for tag {tagName}" : "تعذّر حفظ قاعدة الاحتفاظ المرتبطة بالسِّمَة {tagName} ",
    "Delete retention rule for tag {tagName}" : "إحذِف قاعدة الاحتفاظ المرتبطة بالسِّمَة {tagName} ",
    "Retention rule for tag {tagName} has been deleted" : "تمّ حذف قاعدة الاحتفاظ المرتبطة بالسِّمَة {tagName} ",
