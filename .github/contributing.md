...
* This repository ([Retention](https://github.com/nextcloud/files_retention/issues)) is *only* for issues within the Retention code.
...
[template]: https://raw.github.com/nextcloud/files_retention/master/.github/issue_template.md
